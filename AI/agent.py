...
class Agent:
    ...
    def __init__(self) -> None:
        ...
        self.model = LinearQNet(11, 256, 3) # state.shape, <hidden_size>, action.shape
    ...
    def remember(self, state, action, reward, next_state, done):
        self.memory.append((state, action, reward, next_state, done)) # pop left if exceeds MAX_MEMORY
